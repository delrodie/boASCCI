...
class Information
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Typinfos", inversedBy="informations")
     * @ORM\JoinColumn(name="typinfos_id", referencedColumnName="id")
     */
     private $typinfo;
     ...
     * Set typinfo
     *
     * @param \AppBundle\Entity\Typinfos $typinfo
     *
     * @return Information
     */
    public function setTypinfo(\AppBundle\Entity\Typinfos $typinfo = null)
    {
     ...
     * Get typinfo
     *
     * @return \AppBundle\Entity\Typinfos
     */
