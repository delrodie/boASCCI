...
class MessageController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_message_show', array('slug' => $message->getSlug()));
        }
     ...
     *
     * @Route("/{slug}", name="admin_message_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="admin_message_edit")
     * @Method({"GET", "POST"})
     */
    ...
    private function createDeleteForm(Message $message)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_message_delete', array('id' => $message->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
