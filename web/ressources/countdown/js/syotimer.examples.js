...
$.syotimerLang.neng = {
    second: ['secondone', 'secondfive', 'seconds', 'secondes'],
    minute: ['minuteone', 'minutefive', 'minutes', 'minutes'],
    hour: ['hourone', 'hourfive', 'hours', 'heures'],
    day: ['dayone', 'dayfive', 'days', 'jours'],
    handler: 'nengNumeral'
};
